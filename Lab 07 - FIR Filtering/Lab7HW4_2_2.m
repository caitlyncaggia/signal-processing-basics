%part 4.2: For part j. Identical to code above, except changing inputs to 
%imread, which row is examined, and which subset of the integer deltan 
%values are used.

%part a
im = imread('OFFv3', 'png'); %opens image
xx = im(86, :); %choose a row in the middle
...
%part h
vecin = newdeltan(5:63); %picks a vector of length 59
